...
<?php 
  ...
  $sql = "select reg_id,cust_usr_id,cust_usr_kode,cust_usr_kode_tampilan, cust_usr_nama, cust_usr_tanggal_lahir , poli_nama, reg_tanggal, reg_waktu, tgl_sep, no_sep, jkn_nama, jenis_peserta_txt
                      ...
                      <tbody>
                        ...
                        <tr id="<?= $value['no_sep'];?>">
                          ...
                          <td>
                            ...
                            <a class="btn btn-xs btn-default" href="print-sep.php?reg_id=<?= $value['reg_id'];?>" target="_blank">Print SEP</a>
