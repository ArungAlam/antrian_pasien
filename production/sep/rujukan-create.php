                  ...
                  <div class="x_panel" id="panelB">
                    ...
                    <div class="x_content">
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" class="form-control tgl" name="tgl_rujukan" id="tgl_rujukan" value="<?= date('d-m-Y') ?>">
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Faskes Rujukan</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select class="form-control" name="faskes_rujukan" id="faskes_rujukan">
