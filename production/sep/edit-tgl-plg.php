...
<?php 
  ...
  #data pasien
  $sql = "select reg_id,cust_usr_id, cust_usr_kode,cust_usr_no_hp, cust_usr_nama, poli_nama, reg_tanggal_pulang, reg_waktu_pulang, d.*
                  ...
                  <div class="x_panel" id="panelB">
                    ...
                    <div class="x_content">
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input type="text" class="form-control tgl" name="reg_tanggal_pulang" id="reg_tanggal_pulang" value="<?= format_date($row['reg_tanggal_pulang']) ?>">
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Waktu Pulang</label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input type="text" class="form-control waktu" name="reg_waktu_pulang" id="reg_waktu_pulang" value="<?= $row['reg_waktu_pulang'] ?>">
                        </div>
                      </div>
                    </div>
                    <!-- /.x_content -->
