<?php
    ...
    function GetAntri($status) 
    {
          ...
          $sql = " select b.cust_usr_nama , a.reg_antri_suara, a.reg_antri_nomer, a.reg_antri_id  ,a.id_poli
                  ...
                  where a.reg_antri_suara = '0' and a.id_loket='1' 
     ...
     for($i=0,$counter=0,$n=count($dataTable);$i<$n;$i++,$counter=0){
        ...
        $tbContent[$i][$counter][TABLE_ISI] = '<a href="next_antrian_1.php?id_antri='.$dataTable[$i]["reg_antri_id"].'"><img hspace="2" width="32" height="32" src="'.$ROOT.'gambar/icon/edit.png" alt="Proses" title="Proses" border="0" ></a>';
     ...
     /*   if($dataTable[$i]["id_poli"]==1) $jenisNama="BPJS BARU";
        ...
        $jenisNama = $depKonfig["dep_nama_antrian_loket_satu"];
   ...
   function GetMasuk($status) 
   {
     ...
     for($i=0,$counter=0,$n=count($dataTable);$i<$n;$i++,$counter=0){
        ...
        if(!$dataTable[$i]["id_reg"] && $dataTable[$i]["id_loket"]=="1"){
          ...
          <?php if($_GET["id_antri"]) { ?>
            <div class="page-title">
              <div class="title_left">
                <h1>NOMOR ANTRIAN : <? echo "<b>".$dataPasienAntriReg["reg_antri_nomer"]."</b>&nbsp;";?></h1>
                   <ul class="nav navbar-right panel_toolbox">
                      <button id="btnPanggil" name="btnPanggil" type="submit" value="PANGGIL LOKET 1" class="btn btn-primary" onClick="ProsesAntrian('<? echo $_GET["id_antri"]?>','1')" border="0" />Panggil Loket 1</button>                      <li class="dropdown">
                    </ul>
              </div>
            </div>
             <?php } ?>
