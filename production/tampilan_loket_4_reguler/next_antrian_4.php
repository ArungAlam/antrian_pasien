<?php
    ...
    function GetAntri($status) 
    {
          ...
          $sql = " select b.cust_usr_nama , a.reg_antri_suara, a.reg_antri_nomer, a.reg_antri_id  ,a.id_poli
                  ...
                  where a.reg_antri_suara = '0' and a.id_loket='4' 
     ...
     for($i=0,$counter=0,$n=count($dataTable);$i<$n;$i++,$counter=0){
        ...
        $tbContent[$i][$counter][TABLE_ISI] = '<a href="next_antrian_4.php?id_antri='.$dataTable[$i]["reg_antri_id"].'"><img hspace="2" width="32" height="32" src="'.$ROOT.'gambar/icon/edit.png" alt="Proses" title="Proses" border="0" ></a>';
   ...
   function GetMasuk($status) 
   {
     ...
     for($i=0,$counter=0,$n=count($dataTable);$i<$n;$i++,$counter=0){
        ...
        $tbContent[$i][$counter][TABLE_ISI] = '<a href="next_antrian_4.php?id_antri='.$dataTable[$i]["reg_antri_nomer"].'"><b>'.$dataTable[$i]["reg_antri_nomer"].'</b></a>';
			  $tbContent[$i][$counter][TABLE_ALIGN] = "center";
        $counter++;
        ...
        if(!$dataTable[$i]["id_reg"] && $dataTable[$i]["id_loket"]=="4"){
              ...
              <div class="title_left">
                <h1>NOMOR ANTRIAN : <? echo "<b>".$dataPasienAntriReg["reg_antri_nomer"]."</b>&nbsp;-&nbsp;".$poliNama;?></h1>
                   <ul class="nav navbar-right panel_toolbox">
                      <button id="btnPanggil" name="btnPanggil" type="submit" value="PANGGIL LOKET 4" class="btn btn-primary" onClick="ProsesAntrian('<? echo $_GET["id_antri"]?>','4')" border="0" />Panggil Loket 4</button>                      <li class="dropdown">
                    </ul>
              </div>
            </div>
             <?php } ?>
