		...
		<tr>
            ...
            <tr>
					...
					<table style="width:9cm; height:4cm; border: 2px solid black;">   
					 <!--<tr>
							<td align="left" colspan="2">Nama Pasien : <?php echo $dataPasien["cust_usr_nama"];?>(<?php echo $dataPasien["cust_usr_kode"];?>)</td>
						</tr>-->
            <tr>
							<td align="center" style="font-size:15px;" colspan="2">ANTRIAN <?php echo $poliNama;?></td>
						</tr>
          	<tr>
							<td align="center" style="font-size:150px;" colspan="2"><?php echo $_GET["noantri"];?></td>
						</tr>
						<tr>
							<td align="center" style="font-size:20px;" colspan="2"><?php echo date("d-m-Y H:i:s"); ?></td>
        		</tr>
          </table>
                    <table style="width:9cm; height:4cm; border: 2px solid black; ">
         <!-- <tr>
              
							<td align="center" style="font-size:15px;" colspan="3"><u>SKRINING</u></td>
				  </tr>
          <tr>
							<td align="center" style="font-size:15px;" colspan="2"></td>
              <td align="center" style="font-size:15px;" colspan="2">YA</td>
              <td align="center" style="font-size:15px;" colspan="2">TIDAK</td>
				  </tr>
          <tr>
							<td align="left" style="font-size:15px;" colspan="2">KESAKITAN</td>
              <td align="center" style="font-size:15px;" colspan="2">___</td>
              <td align="center" style="font-size:15px;" colspan="2">___</td>
              
					</tr>
          <tr>
							<td align="left" style="font-size:15px;" colspan="2">RIWAYAT JATUH</td>
              <td align="center" style="font-size:15px;" colspan="2">___</td>
              <td align="center" style="font-size:15px;" colspan="2">___</td>
					</tr>
          <tr>
							<td align="left" style="font-size:15px;" colspan="2">PERLU ALAT BANTU</td>
              <td align="center" style="font-size:15px;" colspan="2">___</td>
              <td align="center" style="font-size:15px;" colspan="2">___</td>
					</tr>
          <tr>
							<td align="left" style="font-size:15px;" colspan="2">BISA BERJALAN SENDIRI</td>
              <td align="center" style="font-size:15px;" colspan="2">___</td>
              <td align="center" style="font-size:15px;" colspan="2">___</td>
					</tr>   -->
