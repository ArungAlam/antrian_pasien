<?php
	...
	function GetJumlah2() {
	  global $dtaccess, $depId;
	   ...
	   $sql = "select count(reg_antri_id) as totali from klinik.klinik_reg_antrian_reguler where id_dep = ".QuoteValue(DPE_CHAR,$depId)." 
            and id_poli='2' 
            and reg_antri_suara='0'";
     $rs = $dtaccess->Execute($sql);
     $dataLoket2 = $dtaccess->Fetch($rs);
     
	 return "Jumlah Antrian : ".$dataLoket2["totali"];
	}
...
/*	i   
     ...
     //die();
      ...
      //BPJS BARU nomer 1-200
      //BPJS LAMA nomer 200-400
      //ONLINE BARU 400-500
      //ONLINE LAMA 500-600
      //UMUM 600-800    
                    
      if($_POST["btnLoketSatu"])
      {
       $sql = "select * from global.global_departemen where dep_id=".QuoteValue(DPE_CHAR,$depId);
        $rs = $dtaccess->Execute($sql);
      ...
      $sql = "select max(reg_antri_nomer) as nomore from klinik.klinik_reg_antrian_reguler where id_poli='1' and id_dep = ".QuoteValue(DPE_CHAR,$depId);          
          $noAntrian = $dtaccess->Fetch($sql);
    	    $noantri =  ($noAntrian["nomore"]+1);
          //if ($noantri<100) $noantri=$noantri+100;
          ...
          $dbTable = "klinik.klinik_waktu_tunggu";
    	    ...
    	    $dbTable = "klinik.klinik_reg_antrian_reguler";
              ...
              $dbField[6] = "reg_antri_tanggal"; 
              $dbField[7] = "id_loket";
              //$dbField[8] = "id_klinik_waktu_tunggu";
             ...
             //$dbValue[8] = QuoteValue(DPE_CHAR,$tungguBaruId);
      ...
      if($_POST["btnLoketEmpat"])
      {
        $sql = "select * from global.global_departemen where dep_id=".QuoteValue(DPE_CHAR,$depId);
        $rs = $dtaccess->Execute($sql);
        $konf = $dtaccess->Fetch($rs);
      
      $sql = "select max(reg_antri_nomer) as nomore from klinik.klinik_reg_antrian_reguler where id_poli='4' and id_dep = ".QuoteValue(DPE_CHAR,$depId);          
          $noAntrian = $dtaccess->Fetch($sql);
    	    $noantri =  ($noAntrian["nomore"]+1);
          //if ($noantri<100) $noantri=$noantri+100;
          if ($noantri<$konf["dep_no_urut_antrian_loket_empat"]) $noantri=$noantri+$konf["dep_no_urut_antrian_loket_empat"];
          ...
          $dbTable = "klinik.klinik_waktu_tunggu";
             ...
             $dbValue[5] = QuoteValue(DPE_CHAR,'0');
             $dbValue[6] = QuoteValue(DPE_DATE,date('Y-m-d'));
             $dbValue[7] = QuoteValue(DPE_CHAR,"4");
             //$dbValue[8] = QuoteValue(DPE_CHAR,$tungguBaruId);
            ...
            $dbValue[2] = QuoteValue(DPE_CHAR,'L');
            $dbValue[3] = QuoteValue(DPE_DATE,date('Y-m-d'));
            $dbValue[4] = QuoteValue(DPE_DATE,date('H:i:s'));
      ...
      if($_POST["btnLoketTiga"])
      {
        $sql = "select * from global.global_departemen where dep_id=".QuoteValue(DPE_CHAR,$depId);
        $rs = $dtaccess->Execute($sql);
        $konf = $dtaccess->Fetch($rs);
      
      $sql = "select max(reg_antri_nomer) as nomore from klinik.klinik_reg_antrian_reguler where id_poli='3' and id_dep = ".QuoteValue(DPE_CHAR,$depId);          
          $noAntrian = $dtaccess->Fetch($sql);
    	    $noantri =  ($noAntrian["nomore"]+1);
          //if ($noantri<100) $noantri=$noantri+100;
          if ($noantri<$konf["dep_no_urut_antrian_loket_tiga"]) $noantri=$noantri+$konf["dep_no_urut_antrian_loket_tiga"];
          ...
          $dbTable = "klinik.klinik_waktu_tunggu";
    	    ...
    	    $dbTable = "klinik.klinik_reg_antrian_reguler";
             ...
             $dbValue[5] = QuoteValue(DPE_CHAR,'0');
             $dbValue[6] = QuoteValue(DPE_DATE,date('Y-m-d'));
             $dbValue[7] = QuoteValue(DPE_CHAR,"3");
             //$dbValue[8] = QuoteValue(DPE_CHAR,$tungguBaruId);
      ...
      if($_POST["btnLoketLima"])
      {
        $sql = "select * from global.global_departemen where dep_id=".QuoteValue(DPE_CHAR,$depId);
        $rs = $dtaccess->Execute($sql);
        $konf = $dtaccess->Fetch($rs);
      
      $sql = "select max(reg_antri_nomer) as nomore from klinik.klinik_reg_antrian_reguler where id_poli='5' and id_dep = ".QuoteValue(DPE_CHAR,$depId);          
          $noAntrian = $dtaccess->Fetch($sql);
    	    $noantri =  ($noAntrian["nomore"]+1);
          //if ($noantri<100) $noantri=$noantri+100;
          if ($noantri<$konf["dep_no_urut_antrian_loket_lima"]) $noantri=$noantri+$konf["dep_no_urut_antrian_loket_lima"];
          ...
          $dbTable = "klinik.klinik_waktu_tunggu";
    	    ...
    	    $dbTable = "klinik.klinik_reg_antrian_reguler";
             ...
             $dbValue[2] = QuoteValue(DPE_CHAR,$idPasien["cust_usr_id"]);
             $dbValue[3] = QuoteValue(DPE_CHAR,$depId);
             $dbValue[4] = QuoteValue(DPE_CHAR,'5');
             $dbValue[5] = QuoteValue(DPE_CHAR,'0');
             $dbValue[6] = QuoteValue(DPE_DATE,date('Y-m-d'));
             $dbValue[7] = QuoteValue(DPE_CHAR,"5");
             //$dbValue[8] = QuoteValue(DPE_CHAR,$tungguBaruId);
      ...
      if($_POST["btnLoketDua"])
      {
        $sql = "select * from global.global_departemen where dep_id=".QuoteValue(DPE_CHAR,$depId);
        $rs = $dtaccess->Execute($sql);
        $konf = $dtaccess->Fetch($rs);
      
      $sql = "select max(reg_antri_nomer) as nomore from klinik.klinik_reg_antrian_reguler where id_poli='2' and id_dep = ".QuoteValue(DPE_CHAR,$depId);          
          $noAntrian = $dtaccess->Fetch($sql);
    	    $noantri =  ($noAntrian["nomore"]+1);
          //if ($noantri<100) $noantri=$noantri+100;
          if ($noantri<$konf["dep_no_urut_antrian_loket_dua"]) $noantri=$noantri+$konf["dep_no_urut_antrian_loket_dua"];
          ...
          $dbTable = "klinik.klinik_waktu_tunggu";
    	    ...
    	    $dbTable = "klinik.klinik_reg_antrian_reguler";
             ...
             $dbValue[5] = QuoteValue(DPE_CHAR,'0');
             $dbValue[6] = QuoteValue(DPE_DATE,date('Y-m-d'));
             $dbValue[7] = QuoteValue(DPE_CHAR,"2");
             //$dbValue[8] = QuoteValue(DPE_CHAR,$tungguBaruId);
      ...
      if($_POST["btnLoketEnam"])
      {
        $sql = "select * from global.global_departemen where dep_id=".QuoteValue(DPE_CHAR,$depId);
        $rs = $dtaccess->Execute($sql);
        $konf = $dtaccess->Fetch($rs);
      
      $sql = "select max(reg_antri_nomer) as nomore from klinik.klinik_reg_antrian_reguler where id_poli='6' and id_dep = ".QuoteValue(DPE_CHAR,$depId);          
          $noAntrian = $dtaccess->Fetch($sql);
    	    $noantri =  ($noAntrian["nomore"]+1);
          //if ($noantri<100) $noantri=$noantri+100;
          if ($noantri<$konf["dep_no_urut_antrian_loket_enam"]) $noantri=$noantri+$konf["dep_no_urut_antrian_loket_enam"];
          ...
          $dbTable = "klinik.klinik_waktu_tunggu";
    	    ...
    	    $dbTable = "klinik.klinik_reg_antrian_reguler";
             ...
             $dbValue[2] = QuoteValue(DPE_CHAR,$idPasien["cust_usr_id"]);
             $dbValue[3] = QuoteValue(DPE_CHAR,$depId);
             $dbValue[4] = QuoteValue(DPE_CHAR,'6');
             $dbValue[5] = QuoteValue(DPE_CHAR,'0');
             $dbValue[6] = QuoteValue(DPE_DATE,date('Y-m-d'));
             $dbValue[7] = QuoteValue(DPE_CHAR,"6");
             //$dbValue[8] = QuoteValue(DPE_CHAR,$tungguBaruId);
            ...
            $dbValue[0] = QuoteValue(DPE_CHAR,$antrianId);       
            $dbValue[1] = QuoteValue(DPE_NUMERIC,2);
            $dbValue[2] = QuoteValue(DPE_CHAR,'t');
            $dbValue[3] = QuoteValue(DPE_DATE,date('Y-m-d'));
            $dbValue[4] = QuoteValue(DPE_DATE,date('H:i:s'));
     ...
     /* if($_POST["btnLama"]){
      ...
      $sql = "select max(reg_antri_nomer) as nomore from klinik.klinik_reg_antrian_reguler where id_poli='2' and id_dep = ".QuoteValue(DPE_CHAR,$depId);          
          $noAntrian = $dtaccess->Fetch($sql);
    	   $noantri =  ($noAntrian["nomore"]+1);
    	    if ($noantri<200) $noantri=$noantri+200;
          $dbTable = "klinik.klinik_waktu_tunggu";
              $dbField[0] = "klinik_waktu_tunggu_id";   // PK
              $dbField[1] = "cetak_antrian";
              $dbField[2] = "klinik_waktu_tunggu_create";
       ...
       if($_POST["btnEks"]){
        ...
        $konf = $dtaccess->Fetch($rs);
          ...
          $sqli = "select id_poli from klinik.klinik_reg_antrian_sms where id_poli='1' and id_dep = ".QuoteValue(DPE_CHAR,$depId);          
          $noAntriann = $dtaccess->Fetch($sqli);
          $polii =  $noAntriann["id_poli"];
          
          $sql = "select max(reg_antri_nomer) as nomore from klinik.klinik_reg_antrian_sms where id_poli='1' and id_dep = ".QuoteValue(DPE_CHAR,$depId);          
          $noAntrian = $dtaccess->Fetch($sql);
    	    $noantri =  ($noAntrian["nomore"]+1);
          
       //   if ($noantri<600) $noantri=$noantri+600;
          if ($noantri<$konf["dep_no_urut_antrian_sms"]) $noantri=$noantri+$konf["dep_no_urut_antrian_sms"];
          ...
          $dbTable = "klinik.klinik_waktu_tunggu";
    	    ...
    	    $dbTable = "klinik.klinik_reg_antrian_sms";
              $dbField[0] = "reg_antri_id";   // PK
              $dbField[1] = "reg_antri_nomer";
              $dbField[2] = "id_cust_usr";
              $dbField[3] = "id_dep";
...
<style type="text/css">
*{ font-weight: bold;}
body{ margin:0; padding:0;background: url('../lcd/bg.jpg'); background-size: 100%;-moz-background-size: 100%;}
#header{margin:0;  width:100%; height:100px;background: #108a49;}
#kiri{padding-top: 10px; padding-left: 10px;}
#kanan{padding-top: 10px; padding-left: 10px; width: 48%; float: left;}
...
.right{ width:230px; height:80px; background-size: 220px 76px; float:right; position: absolute; right: 0; top: 0;}
...
<div id="header">
  <table border="0" width="100%" height="100px">
    <tr>
      <td width="20%" align="center"><img src="<?=$bg?>" height="80px" width="80px" style="border-radius: 150px;"></td>
...
<div align="left">
  ...
  <input type="submit" name="btnLoketSatu" id="btnLoketSatu" style="font-size:2em;width=200px;height:75px" value="<?php echo $konfigurasi["dep_nama_antrian_loket_satu"];?> KLIK DISINI" class="tombol"/></div>

  <div id="loaddiv-2" align="center" class="nomor"><h3><?php echo $konfigurasi["dep_nama_antrian_loket_dua"];?></h3>
  <input type="submit" name="btnLoketDua" id="btnLoketDua" style="font-size:2em;width=200px;height:75px" value="<?php echo $konfigurasi["dep_nama_antrian_loket_dua"];?> KLIK DISINI" class="tombol"/></div> 
</div>
<div align="left">
  <div id="loaddiv-3" align="center" class="nomor"><h3><?php echo $konfigurasi["dep_nama_antrian_loket_tiga"];?></h3>
  <input type="submit" name="btnLoketTiga" id="btnLoketTiga" style="font-size:2em;width=200px;height:75px" value="<?php echo $konfigurasi["dep_nama_antrian_loket_tiga"];?> KLIK DISINI" class="tombol"/></div>
	 <div id="loaddiv-4" align="center" class="nomor"><h3><?php echo $konfigurasi["dep_nama_antrian_loket_empat"];?></h3>
  <input type="submit" name="btnLoketEmpat" id="btnLoketEmpat" style="font-size:2em;width=200px;height:75px" value="<?php echo $konfigurasi["dep_nama_antrian_loket_empat"];?> KLIK DISINI" class="tombol"/></div>
...
<!--<div id="kanan">
  ...
  <div id="loaddiv-5" align="center" class="nomor"><h3><?php //echo $konfigurasi["dep_nama_antrian_loket_lima"];?></h3>
  <input type="submit" name="btnLoketLima" id="btnLoketLima" style="font-size:2em;width=200px;height:75px" value="<?php// echo $konfigurasi["dep_nama_antrian_loket_lima"];?> KLIK DISINI" class="tombol"/></div> 

  <div id="loaddiv-6" align="center" class="nomor"><h3><?php //echo $konfigurasi["dep_nama_antrian_loket_enam"];?></h3>
  <input type="submit" name="btnLoketEnam" id="btnLoketEnam" style="font-size:2em;width=200px;height:75px" value="<?php //echo $konfigurasi["dep_nama_antrian_loket_enam"];?> KLIK DISINI" class="tombol"/></div> 
