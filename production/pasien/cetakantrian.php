...
<body>
	<table border="0">
			...
			<td valign="top">
				<div style="border:0px solid black; width:8cm; height:8cm;">
					<table style="border: 0px solid black; width:8cm;">
						...
						<tr>
							<td align="center" style="font-size:12px;"><?php echo $depNama; ?></td>
						</tr>
						<tr>
							<td align="center" style="font-size:12px;">Jl. Raden Saleh No. 10</td>
						</tr>
						<tr>
							<td align="center" style="font-size:12px;">Karang Tengah</td>
						</tr>
						<tr>
							<td align="center" style="font-size:18px;"><b><?= $jenis[$antri['id_poli']] ?></b></td>
						</tr>
						<tr>
							<td align="center" style="font-size:18px;"><b><?= $poli ?></b></td>
						</tr>
					...
					<table style="border:0px solid black; width:8cm; height:5cm;">
						...
						<tr>
							<td align="center" style="font-size:80px;" colspan="2"><?= $antri['reg_antri_suara'].sprintf("%03d", $antri['reg_antri_nomer']) ?></td>
						</tr>
		<tr>
							<td colspan="2"><hr></td>
		</tr>
		<tr>
			...
			<td align="center" style="font-size:12px;">Budayakan Tertib Antri</td>
		</tr>
		<tr>
			<td align="center" style="font-size:20px;"><?php echo $dataPasien["poli_nama"]; ?></td>
			<td align="center" style="font-size:12px;">Terimakasih Atas Kunjungannya</td>
		</tr>
		<tr>
			<td align="center" style="font-size:20px;">&nbsp;&nbsp;<?php echo $dataPasien["poli_nama"]; ?></td>
