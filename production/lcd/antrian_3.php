...
function()
{
$('#loaddiv-1').fadeOut('slow').load('loket_7.php').fadeIn("slow");
//$('#loaddiv1').load('antri_loket_1.php');

$('#loaddiv-2').fadeOut('slow').load('loket_8.php').fadeIn('slow');
//$('#loaddiv2').load('antri_loket_2.php');

$('#loaddiv-3').fadeOut('slow').load('loket_9.php').fadeIn('slow');
