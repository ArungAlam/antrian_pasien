...
<?php echo $hasil;?>                                                 
<div width="100%">
<h3> LOKET 1</h3><?php //if($dataTable[0]["reg_antri_nomer"]) echo '<img class="pp" src="'.$fotoName.'" />'; ?>
<!-- <div class="nom">

&nbsp;<?php echo $poliNama;?>&nbsp;&nbsp;<?php if($dataTable[0]["reg_antri_nomer"]) echo $dataTable[0]["reg_antri_nomer"];?></div>-->
&nbsp;<font color='black' align="center"><div class="nam"><?php if($dataTable[0]["reg_antri_nomer"]) echo str_pad($dataTable[0]["reg_antri_nomer"],3,"0",STR_PAD_LEFT);?></font></div>
