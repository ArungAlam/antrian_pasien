<?php
     ...
     $lokasi = $ROOT."gambar/foto_pasien";
          ...
          $sql = "select * from klinik.klinik_antrian_reguler where id_dep = ".QuoteValue(DPE_CHAR,$depId)." and id_poli = ".QuoteValue(DPE_CHAR,$poliId)." 
          ...
          $DataAntrian = $dtaccess->Fetch($sql);
            ...
            if($DataSuara[$i]["suara_id"]==$DataAntrian["antri_nomer"] && $DataAntrian["antri_suara"]=="A" && $DataAntrian["id_poli"]==$poliId) {
                $lokasi = $ROOT."suara_5"; // link folder suara poli umum .ogg //
...
<?php echo $hasil;?>
<div width="100%">
<h3> LOKET 5 </h3><?php //if($dataTable[0]["reg_antri_nomer"]) echo '<img class="pp" src="'.$fotoName.'" />'; ?>
<!-- <div class="nom">
