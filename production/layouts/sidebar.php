		        ...
		        <ul class="nav side-menu">
		          ...
		          <li><a style="font-size:15px"><i class="fa fa-money"></i>&nbsp; Antrian <span class="fa fa-chevron-down"></span></a>
		            <ul class="nav child_menu">
		              ...
		              <? if ($auth->IsAllowed("man_ganti_password", PRIV_READ)) { ?><li><a href="<?php echo $ROOT; ?>pasien_regis/antri_tambah.php" target="_blank" style="font-size:15px">Tampilan Pasien New</a></li><? } ?>
		              <!-- <? if ($auth->IsAllowed("man_ganti_password", PRIV_READ)) { ?><li><a href="<?php echo $ROOT; ?>panggil/index.php" target="_blank" style="font-size:15px">Panggilan Antrian</a></li><? } ?> -->
		          ...
		          <li><a style="font-size:15px"><i class="fa fa-money"></i>&nbsp; Antrian Poli <span class="fa fa-chevron-down"></span></a>
		            <ul class="nav child_menu">
		              <? if ($auth->IsAllowed("man_ganti_password", PRIV_READ)) { ?><li><a href="<?php echo $ROOT; ?>antrian_poli/setup_monitor.php" target="_blank" style="font-size:15px">Monitor</a></li><? } ?>
		          ...
		          <li><a style="font-size:15px"><i class="fa fa-money"></i>&nbsp; Antrian Penunjang <span class="fa fa-chevron-down"></span></a>
		            <ul class="nav child_menu">
		              <? if ($auth->IsAllowed("man_ganti_password", PRIV_READ)) { ?><li><a href="<?php echo $ROOT; ?>antrian_penunjang/setup_monitor.php" target="_blank" style="font-size:15px">Monitor</a></li><? } ?>
		              <? if ($auth->IsAllowed("man_ganti_password", PRIV_READ)) { ?><li><a href="<?php echo $ROOT; ?>antrian_penunjang/all_monitor.php" target="_blank" style="font-size:15px">All Monitor</a></li><? } ?>
		              <? if ($auth->IsAllowed("man_ganti_password", PRIV_READ)) { ?><li><a href="<?php echo $ROOT; ?>antrian_penunjang/ruang.php" target="_blank" style="font-size:15px">Setup Ruangan</a></li><? } ?>
		            </ul>
		          </li>
		          <li><a style="font-size:15px"><i class="fa fa-money"></i>&nbsp;Loket <span class="fa fa-chevron-down"></span></a>
		            <ul class="nav child_menu">
		              <li><a href="<?php echo $ROOT; ?>panggil/index.php?id_loket=1" target="_blank" style="font-size:15px">Tampilan Loket 1</a></li>
		              <li><a href="<?php echo $ROOT; ?>panggil/index.php?id_loket=2" target="_blank" style="font-size:15px">Tampilan Loket 2</a></li>
		              <li><a href="<?php echo $ROOT; ?>panggil/index.php?id_loket=3" target="_blank" style="font-size:15px">Tampilan Loket 3</a></li>
		              <li><a href="<?php echo $ROOT; ?>panggil/index.php?id_loket=4" target="_blank" style="font-size:15px">Tampilan Loket 4</a></li>
		              <li><a href="<?php echo $ROOT; ?>panggil/index.php?id_loket=5" target="_blank" style="font-size:15px">Tampilan Loket 5</a></li>
		              <li><a href="<?php echo $ROOT; ?>panggil/index.php?id_loket=6" target="_blank" style="font-size:15px">Tampilan Loket 6</a></li>
		            </ul>
		          </li>
