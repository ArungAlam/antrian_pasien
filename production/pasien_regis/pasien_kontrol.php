...
if ($_POST['cetak']) {
  ...
  $sql = "update klinik.klinik_penjadwalan set is_proses = 'y' where penjadwalan_id = " . QuoteValue(DPE_CHAR, $_POST['no_kontrol']);
...
?>
  <script>
    window.open("cetak_pasien_kontrol.php?id=<?= $_POST['no_kontrol'] ?>", "_blank");
        ...
        <div class="right_col col-md-offset-2 col-md-8" role="main">
          ...
          <div class="x_panel">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <h3 class="col-md-4 col-sm-4 col-xs-4"> No Kontrol</h3>
              <div class="col-md-8 col-sm-8 col-xs-8 input-group">
                <input type="text" name="no_kontrol" value="" placeholder="No Kontrol" class="form-control" style="height: 50px" onkeyup="fun_booking(value.length, value)">
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="right_col col-md-offset-2 col-md-8" role="main">
          <div class="x_panel">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              ...
              <div class="col-md-8 col-sm-8 col-xs-8 input-group">
                <input type="text" class="form-control" name="dokter" id="dokter" value="" placeholder="Dokter" readonly="">
              </div>
            </div>
            <div class="col-md-12 col-sm-12 col-xs-12">
              <label class="control-label col-md-4 col-sm-4 col-xs-4">Tanggal Kontrol</label>
              <div class="col-md-8 col-sm-8 col-xs-8 input-group">
  ...
  function fun_booking(panjang, isi) {
    if (panjang == 10) {
      $.getJSON('data_kontrol.php', {
        ...
        $('#dokter').val(json.usr_name);
        $('#tgl_regitrasi').val(json.penjadwalan_tanggal);
