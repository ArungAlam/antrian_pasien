...
if ($_POST["btnLogin"]) {
      ...
      if ($login) {
            header("Location:" . $ROOT . "production/index_app/index.php");
      } else {
            $errorLogin = 1;
      }
      unset($_POST["txtUser"]);
...
$enc = new textEncrypt();
$lokasi = "login_asset/images";
$fotoName = $lokasi . "/dextra-logo.png";
                  ...
                  <div class="wrap-login100">
                        <form class="login100-form validate-form" name="frmLogin" method="POST" action="<?php echo $_SERVER["PHP_SELF"] ?>">
                              ...
                              <div class="container-login100-form-btn">
                                    <button class="login100-form-btn" name="btnLogin" value="Login">
                                          Login
                                    </button>
                              </div>
                              <br>
                              <center>©PT. EXPRESSA 2020 - <a href="http://www.expressa.id" target="_blank">www.expressa.id</a></center>
                              <input type="hidden" name="cmbSystem" value="1">
                        </form>
                        <div class="login100-more" style="background-image: url('login_asset/images/dextra_queue.jpg');">
